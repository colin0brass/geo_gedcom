    ...
    def __get_event_location(self, record: Record) -> Optional[LifeEvent]:
        ...
        if record:
            ...
            event = LifeEvent(
                ...
                what=record.tag)
            if date:
                self._add_time_reference(event.date)
        return event
